        ...
        <div style="display:flex;flex-direction:column;gap:1.5rem">
          <div style="display:flex;flex-direction:column;gap:1rem">
            <div style="display:flex;align-items:center;justify-content:space-between">
              <h2 style="margin:0;color:var(--text);font-size:var(--text-2xl)">Agendamentos</h2>
            </div>
            
            <!-- CONTROLES (BOTÃO NOVO, FILTROS, IMPRESSÃO) -->
            <div style="display: flex; justify-content: flex-start; align-items: flex-end; gap: 12px; flex-wrap: wrap;">
              <button class="new-apt-btn icon-btn" title="Novo agendamento" style="width:36px;height:36px;font-size:16px;color:var(--muted);flex-shrink:0">+</button>
    ...
    return `
      <div style="padding: 1.5rem;">
        <div style="display: flex; align-items: center; gap: 1rem; margin-bottom: 1.5rem;">
          <div style="font-size:var(--text-2xl);">${renderIcon('REPORT')}</div>
          <div>
            <h1 style="margin: 0; font-size:var(--text-3xl); font-weight:var(--font-bold); color: var(--text);">Agendamentos</h1>
            <p style="margin: 0.25rem 0 0 0; color: var(--muted);">Visualize, edite ou exclua agendamentos.</p>
          </div>
        </div>
        ...
        <div style="display: flex; justify-content: flex-start; align-items: flex-end; gap: 12px; margin-bottom: 1.5rem; flex-wrap: wrap;">
          ...
          <input id="searchPacienteInput" class="input" type="text" placeholder="🔍 Paciente..." value="${this.searchPaciente || ''}" style="width:140px" />
          <input id="searchMedicoInput" class="input" type="text" placeholder="🔍 Médico..." value="${this.searchMedico || ''}" style="width:140px" />
